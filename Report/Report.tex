...
\begin{figure}[!ht]
    ...
    \caption{Microstates time course used as regressors. Shown are four out of the thirty time courses.}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[trim=4cm 0cm 0cm 0cm, scale=0.26]{\imgdir corr}
